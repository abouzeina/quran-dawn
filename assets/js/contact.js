(() => {
    ...
    form.addEventListener('submit', event => {
        ...
        status.textContent = 'Your email draft is ready to open. Send it from your email app. If no app opens, email learn@qurandawn.com directly; your message is still here.';
